...
for t in ['forward', 'backward', 'infer']:
    ...
    for item in log:
        ...
        max_len = training_arg['max_seq_length']
    ...
    label_to_name = ['adapter', 'bias', 'prompt', 'prompt,bias', 'prompt,adapter', 'bias,adapter', 'prompt,bias,adapter']
    label2n = ['AP', 'BF', 'PT', 'PT+BF', 'PT+AP', 'BF+AP', 'PT+BF+AP']
    label_to_color = ['#fe5803', '#a000c6', '#0044fb', '#1a1aeb', '#700a97', '#fd9404', '#d36c62']
