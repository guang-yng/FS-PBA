...
# 
#     input_ids = torch.cat([torch.randint(1, tokenizer.vocab_size-1, (max_length-1, )), torch.tensor([tokenizer.mask_token_id])])
#     attention_mask = torch.ones(max_length)
#     mask_pos = [max_length-1]
#     return {'input_ids': input_ids, 'attention_mask': attention_mask, 'mask_pos': mask_pos}
